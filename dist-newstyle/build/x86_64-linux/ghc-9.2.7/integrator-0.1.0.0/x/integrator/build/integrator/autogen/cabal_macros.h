...
/* package integrator-0.1.0.0 */
#ifndef VERSION_integrator
#define VERSION_integrator "0.1.0.0"
#endif /* VERSION_integrator */
#ifndef MIN_VERSION_integrator
#define MIN_VERSION_integrator(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_integrator */
...
#define CURRENT_COMPONENT_ID "integrator-0.1.0.0-inplace-integrator"
